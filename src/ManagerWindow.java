...
public class ManagerWindow extends javax.swing.JFrame {
 ...
 String customarName,
    ...
    private void initComponents() {
        ...
        newCustomar.setText("New Customer");
        ...
        getIsert.setText("Confirm ");
        getIsert.setToolTipText("");
        ...
        getUpdateCustomar.setText("Update Customer");
...
jTextArea1.setText(addNewProduct.product[getSelected].getDescriptionProduct());
     ...
     JOptionPane.showMessageDialog(this, "  Please Choose In List ): ");
...
//========================================================================================================================================
    ...
    try {
        // Trim inputs
        String idText = getId.getText().trim();
        String nameText = getCustomarName.getText().trim();
        String addressText = getAddress.getText().trim();
        String userText = grtUserName.getText().trim();
        String passText = grtPassword.getText().trim();

        // Check for empty fields
        if (idText.isEmpty() || nameText.isEmpty() || addressText.isEmpty() || 
        ...
        customarId = Long.parseLong(idText);
        customarName = nameText;
        addrees = addressText;
        userName = userText;
        password = Long.parseLong(passText);
        ...
        if (searchId == -1 && searchCustomarName == -1 && searchUserName == -1) {
            ...
            JOptionPane.showMessageDialog(this, "Successfully Added", "Note", 1);
            sizeCustomar++;
            
        } else {
            JOptionPane.showMessageDialog(this, 
                "Error Input\nCheck the User Name, ID, or Customer Name", "Error", 0);
        }

    } catch (NumberFormatException ex) {
        JOptionPane.showMessageDialog(this, "Invalid ID or Password: " + ex.getMessage(), "Error", 0);
    }
...
jListCustomarName[i] = customar[i].getNameCustomer() + " (OK)";
...
// ========================================================================================================================================
 ...
 jListCustomarName = new String[sizeCustomar];
for(int i = 0 ; i < sizeCustomar ; ++i)
jListCustomarName[i] = customar[i].getNameCustomer() ;
